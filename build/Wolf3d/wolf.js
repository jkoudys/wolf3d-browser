...
const Wolf = {
  ...
  TILE2POS(a) { return (((a) << Wolf.TILESHIFT) + Wolf.HALFTILE); },
  POS2TILE(a) { return ((a) >> Wolf.TILESHIFT); },
  POS2TILEf(a) { return ((a) / Wolf.FLOATTILE); },
  ...
  FINE2RAD(a) { return (a * Math.PI / Wolf.ANG_180); },
  RAD2FINE(a) { return (a * Wolf.ANG_180 / Math.PI); },
  FINE2DEG(a) { return (a / Wolf.ANG_1) >> 0; },	// !@# don't lose precision bits
  FINE2DEGf(a) { return (a / Wolf.ANG_1); },
  DEG2FINE(a) { return (a * Wolf.ANG_1); },
