...
Wolf.Angle = (function () {
  Wolf.setConsts({
    DEG2RAD(a) { return a * 0.01745329251994329576; }, // a * M_PI / 180.0f
    RAD2DEG(a) { return a / 0.01745329251994329576; }, // a * 180.0f / M_PI
    ANGLE2SHORT(x) {	return ((x * 65536 / 360) >> 0) & 65535; },
    SHORT2ANGLE(x) {	return x * 360.0 / 65536; },
  });
